package org.opendaylight.yang.gen.v1.urn.sdnhub.odl.tutorial.my.custom.netconf.my.custom.netconf.impl.rev160205 ;
...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "my-custom-netconf-impl";
    private final String namespace = "urn:sdnhub:odl:tutorial:my-custom-netconf:my-custom-netconf-impl";
    private final String revision = "2016-02-05";
    private final String resourcePath = "/META-INF/yang/my-custom-netconf.yang";
